...
from repository.plano_aluno_repository import listar_plano_aluno, cadastrar_plano_aluno, deletar_plano_aluno
from view.planos_view.menu_plano import imprimir_planos
from model.planos_model import identificar_plano, confirmar_cancelar_plano
...
def assinar_plano(id_aluno: int):
    ...
    if total_planos == 0:
        ...
        total_planos_aluno = listar_plano_aluno(id_aluno)
            ...
            while True:
                ...
                try:
                    ...
                    if plano_identificado:
                        ...
                        cadastrar_plano_aluno(id_plano, id_aluno, metodo_pagamento, data_hora)
                        break
                    else:
        ...
        if len(total_planos_aluno) == 0:
            ...
            while True:
                ...
                try:
                    ...
                    if plano_identificado:
                        plano_cancelado = confirmar_cancelar_plano()
