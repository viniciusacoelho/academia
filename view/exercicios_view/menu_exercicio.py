...
from repository.exercicios_repository import cadastrar_exercicio, listar_exercicios, buscar_exercicio, atualizar_exercicio, deletar_exercicio
...
from model.exercicios_model import selecionar_exercicio, identificar_exercicio
