...
from repository.treinos_repository import listar_treinos, buscar_treino, atualizar_treino, deletar_treino
from repository.treinos_repository import cadastrar_treino
from service.treinos_service import validar_nome
from model.alunos_model import selecionar_aluno
from model.treinos_model import identificar_treino, selecionar_treino
            ...
            try:
                ...
                match opcao:
                    case 1:
                        ...
                        atualizar_treino(id_treino, novo_nome, "nome", "Nome")
                        break
                    case 2:
                        menu = ["Empurrar", "Puxar", "Inferior"]
                        for i in range(len(menu)):
